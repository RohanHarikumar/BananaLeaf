...
class Game 
{
    ...
    private void initRooms(String fileName) throws Exception{
    	//String[] collectedKeys = new String[5];
    ...
    private void takeItem(Command command) 
    {
        ...
        tmpColl = currentRoom.getCollectedKeys();
 
        boolean alreadyPicked;
        
        alreadyPicked = currentRoom.CheckcollectedKeys(tmpColl, lRoom);
  
        if (itemType.equals("KEY")) {
    	   if (alreadyPicked) {
    		   System.out.println("You already picked the key from this room ...");
    	   	}
    	   else
    	   	  {
    		   if  (text.contains("Key")){ 
    			   System.out.println("Congrads, you got the key from " + lRoom + "....");
    			   currentRoom.UpdatecollectedKeys(tmpColl, lRoom);  
    			   for (int i = 0; i <5; i++){
    				   System.out.println(tmpColl[i]);
    			   }
    			 //  tmpColl = currentRoom.getCollectedKeys();
    			   //int keyCount = currentRoom.CheckKeyCounts(tmpColl);
    			   //System.out.println("keyCouount "  +  keyCount);
    			   
    		   }else   
    			   System.out.println("There is no "+ itemType + " in "+ lRoom );
    	   }
       }
    }
